...
export default function CollegeHODReports() {
  const { data, loading } = useAPI('/hod/reports', { fallback: {} })
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-dark-200 mt-1.5">Department performance reports.</p>
      </div>
      ...
      <div className="bg-dark-700/60 border border-dark-500/25 rounded-2xl p-6">
        <h3 className="font-semibold font-heading mb-4">Detailed Metrics</h3>
        <div className="space-y-4">
          {[
            { label: 'Present Records', value: att.present || 0 },
            { label: 'Absent Records', value: att.absent || 0 },
