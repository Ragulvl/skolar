...
import {
  ...
  BookOpen, Layers, Copy, CheckCircle2, ChevronRight, ExternalLink
} from 'lucide-react'
...
export default function AdminInstitutionDetail() {
  ...
  const { data: inst, loading } = useAPI(
    institutionId ? `/admin/institutions/${institutionId}/detail` : null,
  ...
  if (!inst) {
    return (
      <div className="text-center py-20">
        ...
        <button onClick={() => navigate('/dashboard/admin/institutions')}
