...
import { Plus, Building2, School, GraduationCap, ChevronRight, Mail, Shield } from 'lucide-react'
...
export default function SuperAdminAdmins() {
  ...
  const { data: admins, loading, refetch } = useAPI('/superadmin/admins', {
    fallback: [],
    staleTime: 60_000,
  })
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-dark-200 mt-1.5">
            {loading ? 'Loading...' : `${admins.length} admin accounts on the platform`}
          </p>
        </div>
      ...
      <div className="relative max-w-sm">
        ...
        <svg className="w-4 h-4 text-dark-400 absolute left-3.5 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
