...
async function main() {
  ...
  const collegeData = [
    ...
    { name: 'Government Arts College Coimbatore',                           code: 'C-41035',  city: 'Coimbatore' },
  ...
  const coimbatoreSchoolData = [
    ...
    { name: 'Delhi Public School Coimbatore',                              code: '1930659',    city: 'Coimbatore' },
    ...
    { name: 'The Indian Public School Coimbatore',                         code: '1930948',    city: 'Coimbatore' },
    { name: 'National Model Senior Secondary School',                      code: '1930267',    city: 'Coimbatore' },
    { name: 'Kendriya Vidyalaya Coimbatore',                              code: '1900009',    city: 'Coimbatore' },
    { name: 'Amrita Vidyalayam Coimbatore',                               code: '1930444',    city: 'Coimbatore' },
    { name: 'BVM Global School Coimbatore',                                code: '1930577',    city: 'Coimbatore' },
    { name: 'Air Force School Coimbatore',                                 code: '1980006',    city: 'Coimbatore' },
    ...
    { name: 'Chinmaya Vidyalaya Coimbatore',                              code: '1930459',    city: 'Coimbatore' },
  ]
  ...
  const palladamSchoolData = [
    { name: 'Government Boys Higher Secondary School Palladam',            code: '33331801215', city: 'Palladam' },
    { name: 'Infant Jesus Matriculation Higher Secondary School Palladam', code: '33331801904', city: 'Palladam' },
    { name: 'Adharsh Vidhyalaya Matric Higher Secondary School Palladam',  code: '33331800809', city: 'Palladam' },
    { name: 'Bharathi Matric Higher Secondary School Palladam',            code: '33331802005', city: 'Palladam' },
    { name: 'Blue Bird Matric Higher Secondary School Palladam',           code: '33331801213', city: 'Palladam' },
    { name: 'VAT Trust Matriculation Higher Secondary School Palladam',    code: '33121800307', city: 'Palladam' },
    { name: 'Infant Jesus Public School Palladam',                         code: '33331801809', city: 'Palladam' },
